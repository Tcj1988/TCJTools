...
@class TCJUploadData;
@interface TCJURLRequest : NSObject
 ...
 *  用于标识不同类型的request状态
 */
@property (nonatomic,assign) TCJApiType apiType;

/**
 *  用于标识不同类型的request
 */
@property (nonatomic,assign) TCJMethodType methodType;

/**
 *  多次请求一个URL 保留第一次或最后一次请求结果 只在请求时有用  读取缓存无效果
 */
@property (nonatomic,assign) TCJResponseKeepType keepType;

/**
 *  操作状态
 */
@property (nonatomic,assign) TCJDownloadState  downloadState;

/**
 *  请求参数的类型
 */
@property (nonatomic,assign) TCJRequestSerializerType requestSerializer;

/**
 *  响应数据的类型
 */
@property (nonatomic,assign) TCJResponseSerializerType responseSerializer;
 ...
 *  为上传请求提供数据
 */
@property (nonatomic,strong,nullable) NSMutableArray<TCJUploadData *> *uploadDatas;
@property (nonatomic, weak, readonly, nullable) id<TCJURLRequestDelegate> delegate;

@property (nonatomic, copy, readonly, nullable) TCJRequestSuccessBlock successBlock;

@property (nonatomic, copy, readonly, nullable) TCJRequestFailureBlock failureBlock;

@property (nonatomic, copy, readonly, nullable) TCJRequestFinishedBlock finishedBlock;

@property (nonatomic, copy, readonly, nullable) TCJRequestProgressBlock progressBlock;
...
@interface TCJBatchRequest : NSObject

/**
 *  请求url 列队容器
 */
@property (nonatomic, strong , nullable) NSMutableArray<TCJURLRequest *> * requestArray;
 ...
 *  上传文件数据的类
 */
@interface TCJUploadData : NSObject
